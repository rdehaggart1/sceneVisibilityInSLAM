...
and then moving down to the bottom of the file and pasting the following line (where &lt;id&gt;PATH&lt;id&gt; is the folder that the <i>ORB_SLAM2_withVisibilityEstimation</i> repository lives in):
...
To check that the operation was successful, you can run:
...
Once this has completed, restart your terminal and run:
